...
<div class="container mt-4">
  <h1>Colours</h1>
  <a href="{{ route('colours.create') }}" class="btn btn-primary">Add Colour</a>
      ...
      <tbody>
          @foreach($colours as $colour)
              <tr>
                  ...
                  <td>{{ $colour->name }}</td>
                  <td>
                      <a href="{{ route('colours.edit', $colour) }}" class="btn btn-warning">Edit</a>
                      <form action="{{ route('colours.destroy', $colour) }}" method="POST" style="display:inline;">
                          @csrf
                          @method('DELETE')
