...
<div class="container mt-4">
  <h1>thêm ảnh sp</h1>
  <a href="{{ route('product_image.create') }}" class="btn btn-primary mb-3">Add New</a>
  <table class="table">
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $image->product->name_sp }}</td>
            <td>{{ $image->colour->name }}</td>
            <td><img src="{{ asset('storage/' . $image->image_path) }}" width="100"></td>
            <td>
                <a href="{{ route('product_image.edit', $image->id) }}" class="btn btn-warning">Edit</a>
